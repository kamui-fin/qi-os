//! Credits to:
//! ---> https://github.com/zesterer/spin-rs/blob/master/src/rwlock.rs
//!
//! A lock that provides data access to either one writer or many readers.
//!
//! Slightly modified to be interrupt aware to prevent deadlocks.
...
impl<T: ?Sized, R> RwLock<T, R> {
    ...
    /// ```
    #[inline]
    fn try_write(&self) -> Option<RwLockWriteGuard<'_, T, R>> {
    ...
    #[inline]
    fn try_upgradeable_read(&self) -> Option<RwLockUpgradableGuard<'_, T, R>> {
